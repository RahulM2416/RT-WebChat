...
export default function App(){
  ...
  const firstName = userName.charAt(0).trim().toUpperCase();
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div className="break-words whitespace-pre-wrap">
                                            <div className="text-[11px] font-bold">{m.sender.charAt(0).toUpperCase()+m.sender.slice(1)}</div>
                                            {m.text}
                                        </div>
                                        <div className="flex justify-between items-center mt-1 text-right ">
                                            {/*<div className="text-[11px] font-bold">{m.sender}</div>*/}
                                            <div className="text-[11px] text-gray-500 text-right ml-auto">
                                                {formatTime(m.ts)}
                                            </div>
                                        </div>
                                    </div>
